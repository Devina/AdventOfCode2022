...
# Loop through 20 rounds and run through inspections
for i in range(20):
    if len(monkey_0) > 0:
...
print("The level of monkey business after 20 rounds of stuff-slinging simian shenanigans: ", sorted(inspection_count)[-1]*sorted(inspection_count)[-2])
